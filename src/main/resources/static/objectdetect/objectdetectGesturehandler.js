...
autoplay = function() {
		...
		getScripts([
			'./objectdetect/compatibility.js',
			'./objectdetect/objectdetect.js',
			'./objectdetect/objectdetect.handfist.js',
			'./objectdetect/jquery.js',
			'./js/index.js'],
						...
						if (coords[0]) {
							...
							if (fist_pos_old) {
								var dx = (fist_pos[0] - fist_pos_old[0]) / video.videoWidth,
									...
									/* Hand motion to the left */
									if (dx > 0.15){
										handleGesture('left');
									} 
									
									/* Hand motion to the right */
									if (dx < -0.15){
										handleGesture('right');
									}
									
									/* Hand motion to the down */
									if (dy > 0.15){
										handleGesture('down');
									}
									
									/* Hand motion to the up */
									if (dy < -0.15){
										handleGesture('up');
									}
